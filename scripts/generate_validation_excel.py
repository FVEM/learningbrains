...
def create_validation_workbook():
    ...
    c_blue = "2563EB"      # Section 2: Purpose & Relevance
    c_indigo = "4F46E5"    # Section 3: Structure & Coherence
    c_sky = "0284C7"       # Section 4: Learning Units
    c_teal = "0D9488"      # Section 5: Competence Framework
    c_emerald = "059669"   # Section 6: Practical Use & Transferability
    c_purple = "7C3AED"    # Section 7: Ethical & Legal Principles
    ...
    group_defs = [
        ...
        (12, 16, "2. PURPOSE & RELEVANCE (P1-P5)", c_blue),
        (17, 20, "3. STRUCTURE & COHERENCE (S1-S4)", c_indigo),
        (21, 24, "4. LEARNING UNITS (U1-U4)", c_sky),
        (25, 28, "5. COMPETENCE FRAMEWORK (C1-C4)", c_teal),
        (29, 33, "6. PRACTICAL USE & TRANSFERABILITY (T1-T5)", c_emerald),
        (34, 37, "7. ETHICAL & LEGAL PRINCIPLES (E1-E4)", c_purple),
    ...
    col_defs = [
        ...
        # Section 2: Purpose & Relevance (1-5) (Cols 12-16)
        (12, "P1", "P1: Clear overall aims", c_blue, 13, "center"),
        (13, "P2", "P2: Realistic learning outcomes", c_blue, 13, "center"),
        (14, "P3", "P3: On-the-job training needs", c_blue, 13, "center"),
        (15, "P4", "P4: Clear target groups", c_blue, 13, "center"),
        (16, "P5", "P5: Relevance to HR & trainers", c_blue, 13, "center"),

        # Section 3: Structure & Coherence (1-5) (Cols 17-20)
        (17, "S1", "S1: Clear structure & navigation", c_indigo, 13, "center"),
        (18, "S2", "S2: 4-part division is logical", c_indigo, 13, "center"),
        (19, "S3", "S3: Coherent unit progression", c_indigo, 13, "center"),
        (20, "S4", "S4: EU frameworks alignment", c_indigo, 13, "center"),

        # Section 4: Learning Units (1-5) (Cols 21-24)
        (21, "U1", "U1: AI core competences", c_sky, 13, "center"),
        (22, "U2", "U2: Clear unit core focus", c_sky, 13, "center"),
        (23, "U3", "U3: Concept/practice balance", c_sky, 13, "center"),
        (24, "U4", "U4: Target & company adaptability", c_sky, 13, "center"),

        # Section 5: Competence Framework (1-5) (Cols 25-28)
        (25, "C1", "C1: KSA structure appropriate", c_teal, 13, "center"),
        (26, "C2", "C2: Alignment with learning units", c_teal, 13, "center"),
        (27, "C3", "C3: Responsible AI attitudes", c_teal, 13, "center"),
        (28, "C4", "C4: Foundation for content creation", c_teal, 13, "center"),

        # Section 6: Practical Use & Transferability (1-5) (Cols 29-33)
        (29, "T1", "T1: Training Programme guidance", c_emerald, 13, "center"),
        (30, "T2", "T2: Useful trainer guidance", c_emerald, 13, "center"),
        (31, "T3", "T3: Adaptation roadmap helpful", c_emerald, 13, "center"),
        (32, "T4", "T4: Clear for external trainers", c_emerald, 13, "center"),
        (33, "T5", "T5: Potential in European contexts", c_emerald, 13, "center"),

        # Section 7: Ethical & Legal Principles (1-5) (Cols 34-37)
        (34, "E1", "E1: Ethical & legal integration", c_purple, 13, "center"),
        (35, "E2", "E2: Suitable for target groups", c_purple, 13, "center"),
        (36, "E3", "E3: Tool & training connection", c_purple, 13, "center"),
        (37, "E4", "E4: Fairness & inclusion", c_purple, 13, "center"),

        # Calculated Averages (Formulas) (Cols 38-44)
        (38, "Mean_Sec2", "Mean Sec 2: Purpose (P1-P5)", c_amber, 15, "center"),
        (39, "Mean_Sec3", "Mean Sec 3: Structure (S1-S4)", c_amber, 15, "center"),
        (40, "Mean_Sec4", "Mean Sec 4: Units (U1-U4)", c_amber, 15, "center"),
        (41, "Mean_Sec5", "Mean Sec 5: Competences (C1-C4)", c_amber, 15, "center"),
        (42, "Mean_Sec6", "Mean Sec 6: Transfer (T1-T5)", c_amber, 15, "center"),
        (43, "Mean_Sec7", "Mean Sec 7: Ethics (E1-E4)", c_amber, 15, "center"),
    ...
    sample_row = 3
    ws_responses.cell(row=sample_row, column=1, value="2026-09-23 12:00:00").alignment = Alignment(horizontal="center")
    ...
    ws_responses.cell(row=sample_row, column=38, value=f"=AVERAGE(L{sample_row}:P{sample_row})").number_format = '0.00'
    # Sec 3: S1-S4 (cols 17-20: Q to T)
    ws_responses.cell(row=sample_row, column=39, value=f"=AVERAGE(Q{sample_row}:T{sample_row})").number_format = '0.00'
    # Sec 4: U1-U4 (cols 21-24: U to X)
    ws_responses.cell(row=sample_row, column=40, value=f"=AVERAGE(U{sample_row}:X{sample_row})").number_format = '0.00'
    ...
    ws_responses.cell(row=sample_row, column=42, value=f"=AVERAGE(AC{sample_row}:AG{sample_row})").number_format = '0.00'
    # Sec 7: E1-E4 (cols 34-37: AH to AK)
    ws_responses.cell(row=sample_row, column=43, value=f"=AVERAGE(AH{sample_row}:AK{sample_row})").number_format = '0.00'
    ...
    questions_data = [
        ...
        ("P1", "Section 2. Purpose and relevance", "The overall aims of the itinerary are clear.", "Los objetivos generales del itinerario son claros.", "Likert Scale (1 - 5)"),
        ("P2", "Section 2. Purpose and relevance", "The main learning outcomes are realistic and appropriate.", "Los principales resultados de aprendizaje previstos son realistas y adecuados.", "Likert Scale (1 - 5)"),
        ("P3", "Section 2. Purpose and relevance", "The itinerary addresses relevant needs related to on-the-job training in industrial companies.", "El itinerario responde a necesidades relevantes relacionadas con el aprendizaje en el puesto de trabajo en empresas industriales.", "Likert Scale (1 - 5)"),
        ("P4", "Section 2. Purpose and relevance", "The intended target groups are clearly identified.", "Los grupos destinatarios previstos están claramente identificados.", "Likert Scale (1 - 5)"),
        ("P5", "Section 2. Purpose and relevance", "The itinerary is relevant to HR and training managers and identified target groups.", "El itinerario es relevante para los responsables de RRHH, formadores y los grupos destinatarios identificados.", "Likert Scale (1 - 5)"),
        ...
        ("S3", "Section 3. Structure and coherence", "The progression between the learning units is coherent.", "La progresión entre las unidades de aprendizaje es coherente.", "Likert Scale (1 - 5)"),
        ("S4", "Section 3. Structure and coherence", "The relationship between the framework, the learning units, the guidance for trainers and the European reference frameworks is clear.", "La relación entre el marco, las unidades de aprendizaje, la guía para formadores y los marcos de referencia europeos es clara.", "Likert Scale (1 - 5)"),
        ...
        ("U3", "Section 4. Learning units", "The balance between conceptual understanding and practical application is appropriate.", "El equilibrio entre la comprensión conceptual y la aplicación práctica es el adecuado.", "Likert Scale (1 - 5)"),
        ("U4", "Section 4. Learning units", "The learning units are sufficiently adaptable to different learner profiles and company contexts.", "Las unidades de aprendizaje son suficientemente adaptables a distintos perfiles de alumnado y contextos de empresa.", "Likert Scale (1 - 5)"),

        # Section 5: Competence framework
        ("C1", "Section 5. Competence framework", "The Knowledge, Skills and Attitudes structure is appropriate for the itinerary.", "La estructura de Conocimientos, Habilidades y Actitudes (KSA) es adecuada para el itinerario.", "Likert Scale (1 - 5)"),
        ("C2", "Section 5. Competence framework", "The competence framework is aligned with the learning units.", "El marco de competencias está debidamente alineado con las unidades de aprendizaje.", "Likert Scale (1 - 5)"),
        ("C3", "Section 5. Competence framework", "The attitudes identified are appropriate for responsible and practical use of AI.", "Las actitudes identificadas son adecuadas para un uso responsable y práctico de la IA.", "Likert Scale (1 - 5)"),
        ("C4", "Section 5. Competence framework", "The competence framework can support the subsequent development of learning content and activities.", "El marco de competencias puede sustentar con éxito el posterior desarrollo de contenidos y actividades formativas.", "Likert Scale (1 - 5)"),

        # Section 6: Practical use and transferability
        ("T1", "Section 6. Practical use and transferability", "The itinerary provides useful guidance for developing a complete Training Programme.", "El itinerario proporciona directrices útiles para el desarrollo de un Programa Formativo integral.", "Likert Scale (1 - 5)"),
        ("T2", "Section 6. Practical use and transferability", "The practical guidance for trainers is useful.", "Las orientaciones prácticas para formadores son de gran utilidad.", "Likert Scale (1 - 5)"),
        ("T3", "Section 6. Practical use and transferability", "The adaptation roadmap can help external trainers adapt the itinerary to different learner groups.", "La hoja de ruta de adaptación puede ayudar a formadores externos a adaptar el itinerario a diversos grupos de participantes.", "Likert Scale (1 - 5)"),
        ("T4", "Section 6. Practical use and transferability", "The itinerary is sufficiently clear to be used by trainers or organisations outside the consortium or beyond the project activities.", "El itinerario es suficientemente claro como para ser utilizado por formadores u organizaciones ajenas al consorcio o más allá de las actividades del proyecto.", "Likert Scale (1 - 5)"),
        ("T5", "Section 6. Practical use and transferability", "The document has potential to support the development of training actions in different European contexts.", "El documento tiene un alto potencial para respaldar el desarrollo de acciones formativas en diversos contextos europeos.", "Likert Scale (1 - 5)"),

        # Section 7: Ethical, legal and inclusive principles
        ("E1", "Section 7. Ethical, legal and inclusive principles", "Ethical and legal aspects are sufficiently integrated into the itinerary.", "Los aspectos éticos y legales están suficientemente integrados en el itinerario.", "Likert Scale (1 - 5)"),
        ("E2", "Section 7. Ethical, legal and inclusive principles", "The treatment of ethical and legal issues is appropriate for the target groups.", "El tratamiento de las cuestiones éticas y legales es adecuado para los grupos destinatarios.", "Likert Scale (1 - 5)"),
        ("E3", "Section 7. Ethical, legal and inclusive principles", "The ethical dimension is connected meaningfully with tool selection, training design and implementation.", "La dimensión ética se conecta de forma significativa con la selección de herramientas, el diseño formativo y su ejecución.", "Likert Scale (1 - 5)"),
        ("E4", "Section 7. Ethical, legal and inclusive principles", "The itinerary gives appropriate attention to fairness, accessibility and inclusion.", "El itinerario presta la debida atención a la equidad, la accesibilidad y la inclusión.", "Likert Scale (1 - 5)"),
    ...
    scale_rows = [
        ...
        ("N/A", "Not applicable / I cannot assess / No aplicable"),
    ]
    ...
    dim_rows = [
        ...
        ("Section 2: Purpose & Relevance Mean", "=AVERAGE(Validation_Responses!AL3:AL500)", "1.00 - 5.00", "Average of items P1 to P5"),
        ("Section 3: Structure & Coherence Mean", "=AVERAGE(Validation_Responses!AM3:AM500)", "1.00 - 5.00", "Average of items S1 to S4"),
        ("Section 4: Learning Units Mean", "=AVERAGE(Validation_Responses!AN3:AN500)", "1.00 - 5.00", "Average of items U1 to U4"),
        ("Section 5: Competence Framework Mean", "=AVERAGE(Validation_Responses!AO3:AO500)", "1.00 - 5.00", "Average of items C1 to C4"),
        ("Section 6: Practical Use & Transferability Mean", "=AVERAGE(Validation_Responses!AP3:AP500)", "1.00 - 5.00", "Average of items T1 to T5"),
        ("Section 7: Ethical & Legal Principles Mean", "=AVERAGE(Validation_Responses!AQ3:AQ500)", "1.00 - 5.00", "Average of items E1 to E4"),
