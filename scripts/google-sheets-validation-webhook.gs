    ...
    if (sheetName === "Itinerario Formativo") {
      if (sheet.getLastRow() === 0) {
        var itHeaders = [
          ...
          "Missing Topics (Q3)",
          "P1: Clear overall aims",
          "P2: Realistic learning outcomes",
          "P3: On-the-job training needs",
          "P4: Target groups clear",
          "P5: Relevance to HR/trainers",
          "S1: Structured & easy navigate",
          "S2: Four parts logical",
          "S3: Unit progression coherent",
          "S4: Reference frameworks clear",
          "U1: Six units cover competences",
          "U2: Core focus descriptions",
          "U3: Concept vs practical balance",
          "U4: Adaptability to profiles",
