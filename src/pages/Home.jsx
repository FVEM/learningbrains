            ...
            <section className="relative min-h-screen flex flex-col overflow-hidden bg-white">
                ...
                <div className="relative z-20 flex-grow flex flex-col justify-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 md:py-20 lg:py-32">
                    <div className="max-w-3xl space-y-8">
                        {/* Validation Badge */}
                        <div className="inline-flex items-center gap-2 px-0 py-1 text-brand-title-blue text-[11px] font-semibold uppercase tracking-wider animate-fade-in-up">
                            <span className="w-1.5 h-1.5 rounded-full bg-brand-title-blue"></span>
