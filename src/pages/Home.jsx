    ...
    return (
        <div className="bg-white font-body text-slate-600">
            ...
            <section className="relative min-h-screen flex flex-col overflow-hidden bg-white">
                ...
                {/* Consortium Band - Glued to the stats above */}
                <div className="w-full bg-white/95 backdrop-blur-md border-y border-slate-100 py-6 md:py-8 relative z-30 animate-fade-in-up delay-500">
